...
from ai.question_generator import (
    ...
    preload_questions, get_cached_question, clear_cache, cache_size
)
...
def quiz_question():
    ...
    difficulty = engine.get_difficulty() if engine else "easy"
...
def quiz_answer():
    ...
    if engine:
        new_difficulty = engine.record_answer(is_correct, response_time)
    else:
        new_difficulty = "easy"
